    ...
    <section>
        <div class="content-wrapper">
            ...
            <div class="content-heading">
                APP List
                <small> Overall Usage Country </small>
            </div>
        ...
        <div class="col-lg-12">
            <div class="row">
                <!--<div class="col-md-2">
                    <div class="input-group date" data-provide="datepicker" v-model="date">
                ...
                <div class="col-md-2">
                    <a  v-on:click="searchSummary"   class="btn btn-labeled btn-info">
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    <div id="table_wrapper" class="dataTables_wrapper form-inline no-footer"><div class="row">
                        <div class="col-xs-6"><div class="dataTables_length" id="table_length">
                            <!--<label>Display <select name="table_length" aria-controls="table" class="form-control input-sm"><option value="10">10</option><option value="25">25</option><option value="50">50</option><option value="100">100</option></select> Records per page</label>-->
                            </div></div><div class="col-xs-6"><div id="table_filter" class="dataTables_filter"><label>Search:<input type="search" class="form-control input-sm" placeholder="" aria-controls="table"></label>
                    </div></div></div><table id="table" class="table table-striped table-hover cursor-pointer dataTable no-footer" role="grid" aria-describedby="table_info">
                        <thead>
                        <tr role="row"><th class="sorting" tabindex="0" aria-controls="table" rowspan="1" colspan="1" aria-label="ID: activate to sort column ascending" style="width: 104px;">Cost</th><th class="sorting" tabindex="0" aria-controls="table" rowspan="1" colspan="1" aria-label="Trunk: activate to sort column ascending" style="width: 188px;">Count</th><th class="sorting_desc" tabindex="0" aria-controls="table" rowspan="1" colspan="1" aria-sort="descending" aria-label="Minutes: activate to sort column ascending" style="width: 242px;">Duration</th><th class="sorting" tabindex="0" aria-controls="table" rowspan="1" colspan="1" aria-label="Cost: activate to sort column ascending" style="width: 164px;">Sms Cost</th><th class="sorting" tabindex="0" aria-controls="table" rowspan="1" colspan="1" aria-label="Cost: activate to sort column ascending" style="width: 164px;">Sms Count</th></tr>
                        </thead>
                        <tbody>
                            <tr class="odd" v-if="loadSummary">
                                <td valign="top" colspan="5" class="dataTables_empty">
                                    <img src="../img/loading.gif" style="height: 50px">
                                </td>
                            </tr>
                            <tr class="odd"  v-if="!loadSummary">
                                <td valign="top" >{{usageSummary.call_cost}}</td>
                                <td valign="top" >{{usageSummary.call_count}}</td>
                                <td valign="top" >{{usageSummary.call_duration}}</td>
                                <td valign="top" >{{usageSummary.sms_cost}}</td>
                                <td valign="top" >{{usageSummary.sms_count}}</td>
                                
                            </tr>
                        </tbody>
                    </table><div class="row"><div class="col-xs-6"><div class="dataTables_info" id="table_info" role="status" aria-live="polite">Showing 0 to 0 of 0 entries</div></div><div class="col-xs-6">
                        <!--<div class="dataTables_paginate paging_simple_numbers" id="table_paginate"><ul class="pagination"><li class="paginate_button previous disabled" aria-controls="table" tabindex="0" id="table_previous"><a href="#">Previous</a></li><li class="paginate_button next disabled" aria-controls="table" tabindex="0" id="table_next"><a href="#">Next</a></li></ul></div>-->
                    </div>
                </div>
            </div>
                </div>
        ...
        getUserInfo: function(){
          ...
          searchSummary: function(){
            ...
            //   console.log(date.replace(/\//g , "-"));
              ...
              this.$http.get(config.api + config.port + 'app/' + user_id + '/usage_by_country/' + newDate, {
                  headers:{
                      "Content-Type": "application/json",
                      "Authorization": newAuthadmin
                  }
                  ...
                  console.log(response)
                  this.usageSummary = response.body.ret;
