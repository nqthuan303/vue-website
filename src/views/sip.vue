<template>
        ...
        <section>
            ...
            <div class="content-heading">
                {{ $route.params.id }}: SIP Accounts
                <small> Manage SIP Accounts </small>
            </div>
        ...
        <div class="col-lg-12">
            <div class="row">
                <div class="col-md-3">
                    <form accept-charset="utf-8" class="form-horizontal" method="POST">                            <!--email_off-->
                    <select class="form-control" id="app_user" name="app_user"><option value="">Select APP user</option></select>                    <input class="form-control" type="hidden" name="_token" value="wvOTshnlqZEs4hBAk7EnQWRFGQkQL4fQrMyCdXvI"></form>                            <!--/email_off-->
                </div>
                <div class="col-md-2">
                    <a href="http://portal.opentact.org/app-users/create-sip-account?app=91" data-target="#myModal" data-toggle="modal" class="btn btn-labeled btn-info">
